...
/**
 * CATOwner model class represents an user model.
 *
 * @author Andreas Sekulski
 */
public class CATOwner extends CATUser {
     ...
     */
    public CATOwner(String username, String password, String domain) throws NoSuchAlgorithmException {
